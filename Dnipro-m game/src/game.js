...
var Game = Game || (function (createjs, $) {
    function Game(canvasId, gameData) {
        ...
        var maxI = 14; //number of element in a row
        var maxJ = 9; //number of element in a column
        ...
        function initialize() {
            ...
            canvasBackground.graphics.setStrokeStyle(1).beginStroke("#F8F3F3").beginFill("#F5F6FA");
            ...
            function createQuestionContainer() {
                ...
                var background = new createjs.Shape();
                background.graphics.setStrokeStyle(1).beginStroke("#BBBDC8").beginFill("#FFFEFE");
